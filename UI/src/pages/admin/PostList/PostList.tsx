          ...
          <tbody className="divide-y divide-gray-100 border-t border-gray-100">
            {posts.length > 0 && posts.map((post: any) => (
              <tr key={post._id} className="hover:bg-gray-50">
                ...
                <td className="text-xs px-6 py-4" >{post.isBlocked ? (
                ...
                <td className="text-xs px-6 py-4">
                  <div className="flex justify-end gap-4">
                    {post.isBlocked ? (
                      <button type="button" style={{ width: '90px' }} onClick={() => handlePostBlock(post._id, "unblock")}
                      ...
                      <button type="button" style={{ width: '110px' }} onClick={() => handlePostBlock(post._id, "block")} className="text-xs bg-white text-red-600 hover:bg-gray-100 border border-gray-200 focus:outline-none font-medium rounded-lg ps-7 py-2.5 text-center inline-flex items-center me-2 mb-2">
