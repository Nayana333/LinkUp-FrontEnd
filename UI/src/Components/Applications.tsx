...
//     try {
//       const response:any = await cancelJobApplication({ applicationId, applicantId: userId });
...
//       try {
//         const response:any = await getEmployeeApplications({ applicantId: userId });
...
import { toast } from "sonner";
import ViewApplication from './ViewApplication';
import ApplicationsSkeleton from '../Components/SkeltonUi/ApplicationSkelton'; 
