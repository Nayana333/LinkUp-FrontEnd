  ...
  return (
    <>
      <div className="home-profile-card bg-white flex flex-col justify-around items-center pt-6 px-6">
        ...
        <div className="flex flex-col items-center">
          <p className="text-sm font-bold flex gap-1 items-center">
            ...
            {user.isPremium && <Target color="green" size={15} />}
          </p>
        ...
        <button 
          ...
          type="submit" 
          className="w-full text-xs border font-bold bg-gray-200 text-black p-3 rounded-md hover:bg-white hover:border hover:text-green-600 transition-colors duration-300"
        >
          View Profile
        </button>
      </div>
      ...
      <div className="home-info-card bg-white flex flex-col justify-around px-6">
        ...
        <button 
          type="submit" 
          className="mt-4 w-full text-xs font-bold bg-black text-white p-3 rounded-md hover:bg-gray-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
        >
          Edit Profile
        </button>
      </div>
