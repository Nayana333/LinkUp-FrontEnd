...
function AddPost() {
 ...
 const [isCroppeSelected, setIsCroppeSelected] = useState(false);
  ...
  return (
    <>
    <div className="home-addpost-section bg-white shadow-lg rounded-lg p-4 my-4">
      <textarea
        className="home-addpost-textarea w-full border-none resize-none outline-none text-gray-600"
        placeholder="What's Happening?"
        rows={3} // Note the change here
      ></textarea>
      <div className="flex items-center justify-between mt-3">
        <div className="home-addpost-button-section flex">
          <ul className="flex gap-4">
            <li className="icon-button">
              <FileImage color="gray" strokeWidth={1.5} size={24} />
            </li>
            <li className="icon-button">
              <Smile color="gray" strokeWidth={1.5} size={24} />
            </li>
            <li className="icon-button">
              <Type color="gray" strokeWidth={1.5} size={24} />
            </li>
            <li className="icon-button">
              <Camera color="gray" strokeWidth={1.5} size={24} />
            </li>
          </ul>
        </div>
        <button
