    ...
    <div className="relative flex flex-col flex-1  items-center justify-center">
      ...
      <ChevronLeft size={18}/> Back
        ...
        <div  className="flex flex-col items-center"  >
            ...
            <p className="mt-5 font-medium">LinkUp Messages</p>
            <p className="text-xs text-gray-600">Connect with professionals, start a conversation, and Link up your connections!</p>
            <p></p>
